...
url = "http://www.cpbl.com.tw/web/team_player.php?&team=B04"
r = requests.get(url)
...
for num in range(10,26):
    ...
    url1 = 'http://www.cpbl.com.tw/players/follow.html?'+id+'&teamno=B04'
...
for num in range(10):
    ...
    id = players[num].get('href').split('&')[1]
    url1 = 'http://www.cpbl.com.tw/players/follow.html?'+id+'&teamno=B04'
    url2 = 'http://www.cpbl.com.tw/players/apart.html?'+id+'&teamno=B04&year=2020&type=05'
    r1 = requests.get(url1)
    soup1 = BeautifulSoup(r1.text,"html.parser")
...
# 儲存成檔案
f = open("富邦2020.json","w",encoding="utf-8")
f1 = open("富邦2020name.json","w",encoding="utf-8")
f.write(jsonData)
f1.write(jsonData1)
f.close()
f1.close()
